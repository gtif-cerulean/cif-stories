...
# CIF Capability: Sea Ice Motion Animation <!--{ as="img" data-fallback-src="" mode="hero" src="https://github.com/BlackCA/cif-stories/blob/BlackCA/polarwarp/assets/BlackCA/BAS-Polarstern-Shackleton.jpg?raw=true" }-->
...
## Who Needs Sea Ice Forecast Information? <!--{ as="img" mode="tour" position="right"}-->
...
#### SAR Image Data
Although any georeferenced image can be used, the system is optimized for SAR (synthetic aperture radar) imagery from:
...
# Example Sea Ice Animation <!--{ as="video" data-fallback-src="https://raw.githubusercontent.com/BlackCA/cif-stories/BlackCA/seaiceanimationupdates01/assets/BlackCA/Enregistrement-decran-le-2026-02-10-a-15.40.22-1770757808845.mov" mode="hero" src="https://raw.githubusercontent.com/gtif-cerulean/cif-stories/d37bd6399bf90e82752c6331d24f610827f6a85b/assets/Enregistrement-decran-le-2026-02-10-a-15.40.22-1770757808845.mov" }-->
 <!--{ style="font-size:1rem;opacity:0.7;margin-top:1rem;" }-->
