...
But polar ice isn’t uniform. Conditions can vary widely from place to place and day to day. POLARIS provides a practical way to assess how safe it is for a specific ship to operate in the ice conditions it faces, whether during voyage planning or in real time on the bridge.
...
POLARIS converts those inputs into a score called the **Risk Index Outcome (RIO)**. This score tells mariners whether the ship can proceed normally, should exercise caution, or should avoid the area altogether.
...
POLARIS relies on national sea ice charts and ship-specific information. Key data sources include:

- **Greenlandic Ice Service** and **Canadian Ice Service** charts (which include essential “stage of development” details)  
...
An international initiative—the **Ice Logistics Portal**—is working to streamline access to these charts.

## What POLARIS Produces

Once the algorithm processes a sea ice chart, it calculates **RIO values for every ship class** across each region of the chart. These results can be displayed as:

- Vector or raster layers in dashboards  
...
POLARIS and RIO scores allows captains and voyage planners to make informed decisions based on real conditions.
...
Organizations like the Arctic Council’s PAME Working Group work with IMO to evaluate and refine how POLARIS supports safe operations and whether future updates are needed.
